...
Creates data like: "tsac: cats" where scrambled word is mapped to original.
"""
import os
import pickle
import random
...
# List of simple 4-letter words to use
words = [
    'cats', 'dogs', 'runs', 'bats', 'hats', 'mats', 'rats',
    'cars', 'bars', 'jars', 'wars', 'vans', 'cans', 'mans',
    'star', 'park', 'dark', 'mark', 'bird', 'word', 'home'
]
